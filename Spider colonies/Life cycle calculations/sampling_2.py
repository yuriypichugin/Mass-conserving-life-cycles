...
"""
sampling \tau_1 and \tau_2 for points in ln(\tau_1/\tau_2) and ln(\tau_1+\tau_2) space
t1 = \tau_1
t2 = \tau_2
rho = t1+ t2
f = t1/t2
transform from (rho, f) -> (t1, t2): t1= rho/(1+f) t2 = rho*f/(1+f)
"""
...
def WriteFile(file):
	...
	fp.write("#SBATCH --time=4-00:00:00\n")
	...
	fp.write("python LifeCycleReconstruction.py %d\n" %ID)

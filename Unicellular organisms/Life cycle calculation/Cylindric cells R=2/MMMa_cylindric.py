...
np.savetxt("SmallOffspringMap_cyl_ke="+str(ke)+"_R="+str(R)+".dat", SmallerOffs, delimiter=",")
np.savetxt("LargeOffspringMap_cyl_ke="+str(ke)+"_R="+str(R)+".dat", LargerOffs, delimiter=",")
np.savetxt("GrowthRatesMap_cyl_ke="+str(ke)+"_R="+str(R)+".dat", GrowthRates, delimiter=",")
np.savetxt("AsymmetriesLowMap_cyl_ke="+str(ke)+"_R="+str(R)+".dat", AsymmetriesLow, delimiter=",")
np.savetxt("AsymmetriesHighMap_cyl_ke="+str(ke)+"_R="+str(R)+".dat", AsymmetriesHigh, delimiter=",")
np.savetxt("CombinedOffspringSize_cyl_ke="+str(ke)+"_R="+str(R)+".dat", CombinedOffSize, delimiter=",")
